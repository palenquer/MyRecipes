...
export function Recipe() {
  ...
  return (
    <main className="container mx-auto py-8 px-2 md:py-0 md:px-0 bg-white xl:py-10 xl:px-40">
      {recipes
        ...
        .map((filteredRecipe) => (
          <section className="p-4">
            ...
            <div className="flex flex-col-reverse lg:flex-row justify-between lg:items-center">
              <h2 className="text-gray-800 break-words max-w-lg">{filteredRecipe.description}</h2>
